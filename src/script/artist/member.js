// Modal d'informations sur les membres

// Base de données fictive des informations sur les membres
const MEMBER_INFO = {
    // Génération automatique d'informations basées sur le nom
    generateInfo: function(memberName) {
        ...
        // Rôles possibles selon la position dans le groupe
        const roles = [
        ...
        // Générer des informations aléatoires mais cohérentes
        const roleIndex = memberName.length % roles.length;
        const role = roles[roleIndex];
        const selectedInstruments = [];
        
        // Sélectionner 1-3 instruments selon le rôle
        ...
        // Générer une date de naissance fictive
...
// Fonction pour ouvrir le modal d'informations sur un membre
function openMemberModal(memberName) {
    console.log('Ouverture du modal pour:', memberName);
    
    // Générer les informations du membre
